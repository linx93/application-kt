...
class MybatisPlusGenerator {
    ...
    fun run() {
        ...
        gc.isSwagger2 = false //开启Swagger2模式
        mpg.globalConfig = gc

        // 3、数据源配置
        val dsc = DataSourceConfig()
        dsc.url = "jdbc:mysql://47.100.162.114:13306/etds?serverTimezone=GMT%2B8"
        ...
        val tables = arrayOf("grant_result_provide_6")
